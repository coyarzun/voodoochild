...
void riff000(){//SOLM
  for(int i=0; i<quantization; i++){
    if(i==0){
      doGuitar(position,i,7,16);
      doGuitar(position,i,7+4,16);
      doGuitar(position,i,7+7,16);
    }
...
void riff001(){//mim
  for(int i=0; i<quantization; i++){
    if(i==0){
      doGuitar(position,i,4,16);
      doGuitar(position,i,4+3,16);
...
void riff002(){//LaM
  for(int i=0; i<quantization; i++){
    if(i==0){
      doGuitar(position,i,9,16);
      doGuitar(position,i,9+4,16);
      doGuitar(position,i,9+7,16);
    }
...
void riff003(){//DoM
  for(int i=0; i<quantization; i++){
    if(i==0){
      doGuitar(position,i,12,16);
      doGuitar(position,i,12+4,16);
      doGuitar(position,i,12+7,16);
    }
...
void riff004(){//LabM
  for(int i=0; i<quantization; i++){
    int f = (i<3)?0:-1;
    if(i==0){
      doGuitar(position,i,8+f,16);
      doGuitar(position,i,8+4+f,16);
      doGuitar(position,i,8+7+f,16);
    }
