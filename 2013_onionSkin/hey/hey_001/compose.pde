...
void riff007(){//
  for(int i=0; i<quantization; i++){
    if(i==0)doBass(position,i,4,2);
    if(i==2)doBass(position,i,4,2);
    if(i==4)doBass(position,i,4,2);
    if(i==6)doBass(position,i,4,2);
    if(i==8)doBass(position,i,4,2);
    if(i==10)doBass(position,i,4,2);    
    if(i==12)doBass(position,i,4,2);    
    if(i==14)doBass(position,i,4,2);    
  }
  position+=quantization;  
}
void riff008(){//
  for(int i=0; i<quantization; i++){
    ...
    if(i==2)doBass(position,i,11,2);
    if(i==4)doBass(position,i,11,2);
    if(i==6)doBass(position,i,11,2);
    if(i==8)doBass(position,i,11,2);
    if(i==10)doBass(position,i,11,2);    
