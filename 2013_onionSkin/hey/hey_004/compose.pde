...
void riff002(){//
  for(int i=0; i<quantization; i++){
    ...
    if(true)doGuitar(position, i, (random(100)>50?0:12)+i>3?14:12, 1);
  }
  position+=quantization;  
}
void riff003(){//
...
void riff007(){//
  for(int i=0; i<quantization; i++){
    ...
    if(true)doGuitar(position, i, random(100)>50?4:16, 1);
  }
  position+=quantization;  
}
void riff008(){//
...
void riff009(){//
  for(int i=0; i<quantization; i++){
    ...
    if(true)doGuitar(position, i, random(100)>50?19:7, 1);
  }
  position+=quantization;  
}
void riff010(){//
  for(int i=0; i<quantization; i++){
    ...
    if(true)doGuitar(position, i, (random(100)>50?0:12)+i>11?4:7, 1);
  }
  position+=quantization;  
}
void riff011(){//
  for(int i=0; i<12; i++){
    ...
    if(true)doGuitar(position, i,random(100)>50?6:18, 1);
  }
  position+=12;  
}
void riff012(){//
