...
void doGuitar(int i, int mode, int scalle, int note, int gmode){
    ...
    //if(i==0)
    {
    kboard.sendNote(new Note(scalle*12+note+12*(i%3!=0?0:1), (int)random(80,100), 32 ));
    kboard.sendNote(new Note(scalle*12+note+3+(gmode==0?0:1)+12*(i%2!=0?0:1), (int)random(80,100), 24 ));
    kboard.sendNote(new Note(scalle*12+note+7+12*(i%4!=0?0:1), (int)random(80,100), 16 ));
    kboard.sendNote(new Note(scalle*12+note+12+12*(i%4!=0?0:1), (int)random(80,100), 8 ));
    }
}
